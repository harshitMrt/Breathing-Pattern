...
const BreathingCircle = ({
  ...
  useEffect(() => {
    ...
    function drawOuterRing(hue, ease, t) {
      ...
      bg.save();
      bg.translate(CX, CY);
      bg.rotate(-Math.PI / 2 + t * 0.00022);

      bg.beginPath();
      bg.arc(0, 0, R, 0, Math.PI * 2);
      bg.strokeStyle = hsla(hue, 40, 55, 0.08);
      bg.lineWidth = 2.5;
      bg.stroke();
      ...
      for (let s = 0; s < segs; s++) {
        ...
        bg.beginPath();
        bg.arc(0, 0, R, a0, a1);
        bg.strokeStyle = hsla(hue, 75, 68, alpha);
        bg.lineWidth = 2.5;
        bg.stroke();
      }
    ...
    function drawWisps(hue, ease, t) {
      ...
      for (const w of WISPS) {
        ...
        const x0 = Math.cos(a) * innerR,
          y0 = Math.sin(a) * innerR;
        const x1 = Math.cos(a) * outerR,
          y1 = Math.sin(a) * outerR;
        ...
        fx.beginPath();
        fx.moveTo(x0, y0);
        fx.quadraticCurveTo(cx, cy, x1, y1);
        fx.strokeStyle = gd;
